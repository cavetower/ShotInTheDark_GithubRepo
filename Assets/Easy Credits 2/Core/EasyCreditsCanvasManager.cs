...
namespace Onerat.EasyCredits
{
	public class EasyCreditsCanvasManager : MonoBehaviour
	{
		...
		private RenderMode CanvasRenderMode => this.GetComponent<EasyCreditsDataManager>().CanvasRenderMode;
		public bool CameraOrthographic => this.GetComponent<EasyCreditsDataManager>().CameraOrthographic;
		public Camera Camera => this.GetComponent<EasyCreditsDataManager>().Camera;
		...
		public void AddInlay(EasyCreditsInlay inlay, EasyCreditsDataManager.InlayType inlayType, int count) {
			...
			if (!dataManager) { dataManager = this.GetComponent<EasyCreditsDataManager>(); }               
